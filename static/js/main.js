...
(function ($) {
    ...
    var today = new Date();
    // Set the target date to one month from the current date
    var targetDate = new Date(today.getFullYear(), today.getMonth() + 1, today.getDate());
    ...
    /*-------------------
		Quantity change
	--------------------- */
    var proQty = $('.pro-qty form');
    proQty.prepend('<span class="dec qtybtn">-</span>');
    proQty.append('<span class="inc qtybtn">+</span>');
    proQty.on('click', '.qtybtn', function () {
        var $button = $(this);
        var oldValue = $button.siblings('input[name="quantity"]').val();
        ...
        $button.siblings('input[name="quantity"]').val(newVal);
    });

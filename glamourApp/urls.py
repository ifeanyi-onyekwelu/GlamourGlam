...
urlpatterns = [
    ...
    path('order-complete/<uuid:order_id>', OrderCompletePageView.as_view(), name="order_complete"),
    ...
    path('delete-item/<uuid:cart_item_id>/', handleRemoveCartItem, name="handleRemoveCartItem"),
